...
- Rientrare nell'edificio senza autorizzazione`,
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: 'ai2_boss5',
          question: 'Quale di queste azioni va eseguita PRIMA di iniziare un intervento con estintore portatile su un principio di incendio?',
          options: [
            'Aprire porte e finestre per far uscire il fumo',
            'Valutare la via di fuga alle proprie spalle e posizionarsi sopravvento',
            'Spruzzare l\'estintore direttamente sulle fiamme più alte',
            'Avvicinarsi il più possibile al focolaio per essere più efficaci',
          ],
          correctIndex: 1,
          explanation: 'Prima di intervenire occorre SEMPRE avere una via di fuga libera alle spalle e operare sopravvento (vento alle spalle), per non restare intrappolati dai fumi o dalle fiamme.',
          xpReward: 30,
          difficulty: 'medium',
        },
      ],

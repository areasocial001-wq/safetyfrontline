...
const FIRE_CLASSES = [
  ...
  },
  {
    class: 'C',
    name: 'Classe C (Gas)',
    description: 'Incendi di gas infiammabili: metano, GPL, idrogeno, acetilene. Prima azione: chiudere la valvola.',
    icon: Flame,
    color: 'text-yellow-500',
    bgColor: 'bg-yellow-500/10',
    borderColor: 'border-yellow-500/40',
    examples: ['Bombole GPL', 'Tubazioni metano', 'Bombole acetilene', 'Fughe di gas'],
    bestExtinguisher: 'powder',
    bestLabel: 'Polvere',
    goodExtinguishers: ['co2'],
